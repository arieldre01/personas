...
export const scenarios: Scenario[] = [
  ...
  // MATEO - Early Adopter (Gen Y)
  {
    id: 'mateo-ai-tool-announcement',
    title: 'AI Tool Announcement',
    description: 'Share news about a new AI tool with Mateo in his preferred style.',
    difficulty: 'Easy',
    personaId: 'mateo',
    userRole: 'Product Communications Lead',
    context: `You are Mateo, an early adopter eager to learn about new AI tools at Amdocs. You want to know: What's the tool? How do I access it? What can it do for my work? Keep it short and technical - no corporate fluff.`,
    userGoal: 'Communicate the AI tool launch in a way that resonates with technical early adopters.',
    evaluationCriteria: ['Kept it concise (under 5 bullets)', 'Included access instructions', 'Showed real use cases', 'Avoided corporate jargon'],
    estimatedMinutes: 5,
  },
  {
    id: 'mateo-learning-resources',
    title: 'Learning Path Discussion',
    description: 'Mateo wants access to AI learning resources. Help him find what he needs.',
    difficulty: 'Medium',
    personaId: 'mateo',
    userRole: 'L&D Manager',
    context: `You are Mateo, eager to upskill in AI and machine learning. You've heard about Copilot, Tan9, and other tools but don't know how to get access or training. You want hands-on learning, not lectures.`,
    userGoal: 'Understand Mateo\'s learning needs and provide practical resources.',
    evaluationCriteria: ['Asked about specific interests', 'Provided concrete access paths', 'Offered hands-on options', 'Connected him with peer learners'],
    estimatedMinutes: 6,
  },
  {
    id: 'mateo-roadmap-feedback',
    title: 'Tech Roadmap Feedback',
    description: 'Get Mateo\'s honest feedback on the technology roadmap communication.',
    difficulty: 'Medium',
    personaId: 'mateo',
    userRole: 'Internal Communications Manager',
    context: `You are Mateo, and you just received a long email about the technology roadmap. It was full of corporate language and didn't clearly explain what's changing, when, or how it affects your work. You have strong opinions about how it should be communicated.`,
    userGoal: 'Gather Mateo\'s feedback and show commitment to improving tech communications.',
    evaluationCriteria: ['Listened without being defensive', 'Asked for specific examples', 'Committed to shorter formats', 'Involved him in improvements'],
    estimatedMinutes: 6,
  },
  {
    id: 'mateo-early-access',
    title: 'Early Access Request',
    description: 'Mateo requests early access to a beta AI feature.',
    difficulty: 'Easy',
    personaId: 'mateo',
    userRole: 'R&D Product Manager',
    context: `You are Mateo, and you heard about a new AI code assistant being piloted. You want early access so you can test it, provide feedback, and be ready when it launches. You have ideas for how it could help your team.`,
    userGoal: 'Evaluate Mateo\'s request and decide on early access.',
    evaluationCriteria: ['Asked about his use case', 'Explained the beta process', 'Made a clear decision', 'Valued his enthusiasm'],
    estimatedMinutes: 5,
  },
];
